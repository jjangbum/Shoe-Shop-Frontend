  ...
  return (
    <>
      ...
      <div className='h-screen w-full flex flex-row justify-center'>
        <div className='h-screen w-4/5 block md:flex md:justify-center'>
          <div className='h-auto w-11/12 sm:w-1/2 md:w-2/5 flex flex-col justify-center ml-0 md:ml-16 mt-36 md:mt-0'>
          ...
          <div className='h-auto w-full md:w-1/2 flex items-center justify-center mt-6 md:mt-0'>
            <img
              src={Shopping}
              alt='shopping'
              className='h-64 w-64 lg:h-88 lg:w-88 xl:h-auto xl:w-auto animate-bounce-slow'
            />
          </div>
        </div>
      </div>
