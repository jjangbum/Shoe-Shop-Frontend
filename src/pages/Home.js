  ...
  return (
    <>
      ...
      <div className='h-screen w-full flex justify-center bg-gradient-to-b from-slate-50 via-slate-100 to-blue-200'>
        <div className='h-auto w-10/12 md:w-10/12 xl:w-8/12 2xl:w-7/12 block md:flex md:flex-row justify-center'>
          <div className='h-auto w-11/12 sm:w-1/2 md:w-1/2 flex flex-col justify-center md:ml-14 lg:ml-28 xl:ml-10 mt-32 md:mt-0'>
            ...
            <Link
              to='/item'
              className='bg-slate-800 text-slate-50 text-lg lg:text-xl font-semibold w-7/12 sm:w-2/3 md:w-2/3 lg:w-1/2 max-w-[180px] px-4 py-4 rounded-lg flex flex-row items-center justify-center hover:opacity-90'>
              구매하러 가기!
            </Link>
          </div>
